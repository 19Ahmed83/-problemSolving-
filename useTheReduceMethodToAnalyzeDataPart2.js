...
function getRating(watchList) {
    let averageRating = watchList.filter(el => el['Director'] === 'Christopher Nolan');
    let newArr = averageRating.reduce((sum, user) => sum + +user['imdbRating'], 0)
    return newArr / averageRating.length
}
